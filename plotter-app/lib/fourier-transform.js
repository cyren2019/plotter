...
function transform(input) {
	...
	while ((nn = nn >>> 1)) {
		...
		for (let j = 0; j < count; j++) {
			...
			do {
				for (let i0 = ix; i0 < N; i0 += id) {
					const i1 = i0 + j + 1, i2 = i1 + n4, i3 = i2 + n4, i4 = i3 + n4
					const i5 = i0 + n4 - j - 1, i6 = i5 + n4, i7 = i6 + n4, i8 = i7 + n4
...
// Complex FFT for real input — returns [re, im] (N/2+1 bins)
...
window.FourierTransform = { fft: fft, rfft: rfft };
